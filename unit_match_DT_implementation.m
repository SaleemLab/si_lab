...
no_probe = 1;
UMparam.SaveDir = fullfile(ephys_folder,['probe',num2str(no_probe)-1],'unit_match'); % Recommended to use end this path with \Probe0\IMRO_1\ if more probes/IMRO tables were used or \AllProbes\AllIMRO\ otherwise
...
probe0_ks3_raw_waveform_path =fullfile(UMparam.KSDir{1,1},'RawWaveforms');
