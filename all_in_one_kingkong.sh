...
#python download_kingkong.py $mouse $dates $save_date $base_folder $no_probe $use_ks4 $use_ks3
python premerging_kingkong_probe0_temp.py $mouse $dates $save_date $base_folder $no_probe $use_ks4 $use_ks3
...
dates='20241214/20241214_0' #acquisition date and session e.g. dates='20240624/20240624_0,20240624/20240624_1'
base_folder='/home/masa/spikesorting_temp_data/'  # local folder of godzilla
no_probe=2 #number of probes you have in this session
use_ks4=true #use kilosort4 
use_ks3=true #use kilosort3
...
# Run the first Python script with inputs
python download_kingkong.py $mouse $dates $save_date $base_folder $no_probe $use_ks4 $use_ks3
python premerging_kingkong_probe1.py $mouse $dates $save_date $base_folder $no_probe $use_ks4 $use_ks3
python premerging_kingkong_probe0.py $mouse $dates $save_date $base_folder $no_probe $use_ks4 $use_ks3
...
dates='20241218/20241218_0,20241218/20241218_1' #acquisition date and session e.g. dates='20240624/20240624_0,20240624/20240624_1'
base_folder='/home/masa/spikesorting_temp_data/'  # local folder of godzilla
no_probe=2 #number of probes you have in this session
use_ks4=true #use kilosort4 
use_ks3=true #use kilosort3
...
#python premerging_zarr_kingkong_probe1.py $mouse $save_date $base_folder $no_probe $use_ks4 $use_ks3 $g_files_to_ignore
#python premerging_zarr_kingkong_probe0.py $mouse $save_date $base_folder $no_probe $use_ks4 $use_ks3 $g_files_to_ignore
