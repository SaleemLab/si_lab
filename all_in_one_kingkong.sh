...
python download_kingkong.py $mouse $save_date $base_folder $no_probe $use_ks4 $use_ks3
python premerging_kingkong_probe1.py $mouse $save_date $base_folder $no_probe $use_ks4 $use_ks3
python premerging_kingkong_probe0.py $mouse $save_date $base_folder $no_probe $use_ks4 $use_ks3
