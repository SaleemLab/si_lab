...
probe0_sorting_ks4 = si.run_sorter(sorter_name= 'kilosort4',recording=probe0_preprocessed_corrected,folder=save_folder+'probe0/sorters/kilosort4/',docker_image=True,do_correction=False)
