...
folders_to_move = ['probe0_preprocessed']
...
probe0_sorting_ks4 = si.run_sorter(sorter_name= 'kilosort4',recording=probe0_preprocessed_corrected,output_folder=dst_folder+'probe0/sorters/kilosort4/',docker_image="spikeinterface/kilosort4-base:latest",do_correction=False)
...
probe0_we_ks4 = si.extract_waveforms(probe0_preprocessed_corrected, probe0_sorting_ks4, folder=dst_folder +'probe0/waveform/kilosort2_5',
...
probe1_we_ks4 = si.extract_waveforms(probe0_preprocessed_corrected, probe1_sorting_ks4, folder=dst_folder +'probe0/waveform/kilosort3',
                        sparse=True, max_spikes_per_unit=500, ms_before=1.5,ms_after=2.,
                        **job_kwargs)
...
dat_files = [ dst_folder + "probe0/sorters/kilosort4/sorter_output/temp_wh.dat",
            dst_folder + "probe1/sorters/kilosort4/sorter_output/temp_wh.dat"]
