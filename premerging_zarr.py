...
for probe in range(int(no_probe)):
    ...
    if use_ks4:
        ...
        save_spikes_to_csv(ks4_spikes,save_folder + 'probe'+str(probe)+'/waveform/kilosort4/in_container_sorting/')
    ...
    if use_ks3:
        ...
        save_spikes_to_csv(ks3_spikes,save_folder + 'probe'+str(probe)+'/waveform/kilosort3/in_container_sorting/')
