...
dates='20240718/20240718_0,20240718/20240718_1,20240718/20240718_2' #acquisition date and session e.g. dates='20240624/20240624_0,20240624/20240624_1'
...
python premerging_masa_local_ks3.py $mouse $dates $save_date $base_folder $no_probe $use_ks4 $use_ks3 $g_files_to_ignore
