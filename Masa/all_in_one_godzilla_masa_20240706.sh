...
save_date='20240706' #date of recording
dates='20240706/20240706_0' #acquisition date and session e.g. dates='20240624/20240624_0,20240624/20240624_1'
...
python premerging_masa_local.py $mouse $dates $save_date $base_folder $no_probe $use_ks4 $use_ks3 $g_files_to_ignore
