...
for no_probe = 1:2
    ...
    ks_sparsity_path = fullfile(ephys_folder,['probe',num2str(no_probe)-1],'waveform','kilosort4','sparsity.json');
    ks_waveform_path = fullfile(ephys_folder,['probe',num2str(no_probe)-1],'waveform','kilosort4','waveforms');
